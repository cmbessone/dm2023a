...
PARAM  <- list()
PARAM$experimento  <- "ZZ7950SEM1"
PARAM$exp_input  <- "HT7510SEM1"
...
PARAM$semilla_primos  <- 863767  # semiskilled utiliza para generar el vector de  PARAM$semillerio  semillas
