...
PARAM  <- list()
PARAM$experimento <- "FE7310SEM1"

PARAM$exp_input  <- "DR7210SEM1"
...
PARAM$RandomForest$semilla  <- 863767    # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla  <- 227743   # cambiar por la propia semilla
